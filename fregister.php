<?php 
        $title = 'flightreservation Airlines | User Registration'; 
          ...
          <div class="well bs-component">
			<?php  
				...
				if(isset($_GET['success']) && empty($_GET['success'])) {
					echo 'You have been registered to flightreservation Airlines successfully! Please check your Email ID for activation link!';
				} 
				else {
...
include $_SERVER["DOCUMENT_ROOT"].'/flightreservation/includes/overall/footer.php'; ?>  
